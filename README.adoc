...
gradle htop hugo jenv openjdk@17 jq maven nodenv openshift-cli romkatv/powerlevel10k/powerlevel10k \
plantuml postgresql pyenv; \
❯ brew install cask dbeaver-community gureumkim rectangle docker 
```
